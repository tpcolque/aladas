...
public class VueloService {
    ...
    public Vuelo crear(Date fecha, Integer capacidad, String aeropuertoOrigenIATA, String aeropuertoDestinoIATA, BigDecimal precio, String codigoMoneda){
        ...
        vuelo.setAeropuertoOrigen(aeropuertoOrigen.getAeropuertoID());//originalmente este atributo es Integer pero para usar los codigos iata lo tengo que transformar en String
    ...
    public enum ValidacionVueloDataEnum{
        OK, ERROR_PRECIO, ERROR_AEROPUERTO_ORIGEN, ERROR_AEROPUERTO_DESTINO, ERROR_FECHA, ERROR_MONEDA, ERROR_CAPACIDAD_MINIMA, ERROR_CAPACIDAD_MAXIMA, ERROR_AEROPUERTOS_IGUALES, ERROR_GENERAL
